...
export * as govnSvcImport from "https://denopkg.com/gov-suite/governed-service-helpers@v0.3.13/import.ts";
export * as govnSvcMetrics from "https://denopkg.com/gov-suite/governed-service-helpers@v0.3.13/metrics.ts";
export * as govnSvcVersion from "https://denopkg.com/gov-suite/governed-service-helpers@v0.3.13/version.ts";
export * as govnData from "https://denopkg.com/gov-suite/governed-structured-data@v0.7.9/mod.ts";
export * as prometheus from "https://denopkg.com/marcopacini/ts-prometheus@v0.1.1/mod.ts";
