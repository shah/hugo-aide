...
export * as encodingTOML from "https://deno.land/std@0.98.0/encoding/toml.ts";
export * as encodingYAML from "https://deno.land/std@0.98.0/encoding/yaml.ts";
...
export * as uuid from "https://deno.land/std@0.98.0/uuid/mod.ts";
...
export * as extend from "https://denopkg.com/shah/ts-extend@v0.4.0/mod.ts";
...
export * as shcGitLab from "https://denopkg.com/shah/ts-safe-http-client@v0.9.1/git/github/mod.ts";
export * as shcGitHub from "https://denopkg.com/shah/ts-safe-http-client@v0.9.1/git/gitlab/mod.ts";
export * as safeHttpClient from "https://denopkg.com/shah/ts-safe-http-client@v0.9.1/git/mod.ts";
